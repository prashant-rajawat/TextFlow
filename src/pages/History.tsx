    ...
    <div className="w-full max-w-5xl mx-auto px-4 py-6 space-y-6 relative">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-200 dark:border-slate-800">
        <div className="space-y-1">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-xl bg-indigo-600/10 text-indigo-600 dark:bg-indigo-500/20 dark:text-indigo-400 flex items-center justify-center font-bold">
        ...
        <div className="flex items-center gap-3">
          ...
          {pagination.total > 0 && (
            <button
              ...
              className="px-3.5 py-2 rounded-xl border border-red-200 dark:border-red-900/60 bg-red-50/50 dark:bg-red-950/30 text-red-700 dark:text-red-300 hover:bg-red-100 dark:hover:bg-red-900/50 text-xs font-semibold flex items-center gap-1.5 transition-colors shrink-0"
            >
      ...
      {isLoading ? (
        ...
        <div className="p-8 rounded-2xl border border-red-200 dark:border-red-900/60 bg-red-50/40 dark:bg-red-950/20 text-center space-y-4 max-w-md mx-auto">
          ...
          <div className="space-y-1">
            <h3 className="text-sm font-bold text-red-900 dark:text-red-200">Unable to load speech history</h3>
        ...
        <div className="p-12 rounded-2xl border border-dashed border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 text-center space-y-4 max-w-md mx-auto">
          ...
          <div className="space-y-1">
            <h3 className="text-base font-bold text-slate-900 dark:text-slate-100">No Speech History Yet</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">
              {searchQuery
        ...
        <div className="space-y-4">
          {historyItems.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="p-5 rounded-2xl border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xs hover:border-slate-300 dark:hover:border-slate-700 transition-all space-y-4"
              >
                {/* Text Content */}
